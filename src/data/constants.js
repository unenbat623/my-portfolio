...
export const projectsMn = [
  {
    ...
    date: "2026 оны 8 сар - Одоо",
    description:
      "AI-д суурилсан хувийн амьдралын удирдлагын систем. Өдөр тутмын төлөвлөгөө, зорилго, дадал, тэмдэглэл, календарь, цаг агаарын мэдээллийг нэг дороос удирдах Life OS платформ. Next.js frontend, FastAPI backend, Docker infrastructure бүхий monorepo бүтэцтэй.",
    image: "/img/projects/personal-lifestyle.png",
    tags: ["Next Js", "TypeScript", "FastAPI", "PostgreSQL", "Docker"],
    category: "web app",
    github: "https://github.com/unenbat623/personal-lifestyle",
    webapp: "https://web-omega-one-16.vercel.app/",
  },
  {
    id: 27,
    title: "Zity Shop",
    date: "2026 оны 8 сар",
    description:
      "Zity Chef Complex-ийн албан ёсны e-commerce веб апп. Odoo ERP-тэй бодит цагийн барааны үлдэгдэл, захиалгын sync, QPay төлбөрийн урсгал, хоолны жорын орц багц худалдан авах Zity Chef ecosystem интеграцтай.",
    image: "/img/projects/zity-shop.jpg",
    tags: ["React 19", "TypeScript", "Odoo ERP", "Zustand", "Tailwind CSS"],
    category: "web app",
    github: "https://github.com/unenbat623/zity-shop",
    webapp: "https://zity-shop.vercel.app",
  },
  {
    id: 0,
    title: "Djgeo.mn",
...
export const projects = [
  {
    ...
    description:
      "An AI-powered personal life operating system for managing daily plans, goals, habits, notes, calendar, and weather in one place. Built as a monorepo with a Next.js frontend, FastAPI backend, and Docker-based infrastructure.",
    image: "/img/projects/personal-lifestyle.png",
    tags: ["Next Js", "TypeScript", "FastAPI", "PostgreSQL", "Docker"],
    category: "web app",
    github: "https://github.com/unenbat623/personal-lifestyle",
  ...
  },
  {
    ...
    date: "Aug 2026",
    description:
      "The official e-commerce web app for Zity Chef Complex, integrated with Odoo ERP for real-time stock and order sync, QPay payment flows, and recipe meal-kit bundles from the Zity Chef ecosystem.",
    image: "/img/projects/zity-shop.jpg",
    tags: ["React 19", "TypeScript", "Odoo ERP", "Zustand", "Tailwind CSS"],
    category: "web app",
    github: "https://github.com/unenbat623/zity-shop",
